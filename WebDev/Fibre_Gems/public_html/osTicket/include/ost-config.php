...
define('SECRET_SALT','3ac4b10970546c767db33e3a935f107d');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','George@fibregems.com');
...
define('DBNAME','fibregems_ost864');
define('DBUSER','fibregems_ost864');
define('DBPASS','p09.vS]5N5');
